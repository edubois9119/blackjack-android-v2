...
public interface DeckOfCardsService {
                                             // only static final fields are allowed in interfaces
  URL getImageUrl(Context context, Card card);          // abstract method that will return a URL
  ...
  class InstanceHolder {
    ...
    static {
      INSTANCE = new DeckOfCardsService() {                 //anonymous class
        @Override
